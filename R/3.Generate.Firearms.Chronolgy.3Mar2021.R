...
source("C:\\Documents\\Manuscripts\\Feral Swine - MIS Data Description\\Code\\FNC.MIS.assign.orphen.events.R")
source("C:\\Documents\\Manuscripts\\Feral Swine - MIS Data Description\\Code\\FNC.MIS.merge.trap.events.R")
...
uom.name <- c("HOURS","MINUTES","ATV HOURS","DRIVE HOURS")
...
#----Write Data
write.csv(final.agg.out.dat, paste0(write.path,"feral.swine.effort.take.firearms.ALL.daily.",Sys.Date(),".csv"))
...
write.csv(missing.agrp.id,"C:/Documents/Manuscripts/Feral Swine - MIS Data Description/Data/missing.agrp.id.csv",row.names=FALSE)
